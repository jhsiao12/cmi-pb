### Overview
This project involves the analysis of pertussis vaccine immune response data, with a specific focus on predicting and ranking IgG-PT-D14-titer and IgG-PT-D14-titer fold change values. Analysis using various machine learning models.


### Project Structure
1. Data Loading and Cleaning
The project begins with loading data from different sources related to plasma antibody titers, specimens, and subject information for multiple years (2020, 2021, 2022).
